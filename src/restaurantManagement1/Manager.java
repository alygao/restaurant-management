...
public class Manager extends Employee	{
	...
	/**
	 * Manager constructor
	 * initialize the manager with all required values
	 ...
	 */
	public Manager(String name, double pay, String userID, String password, String dateHired, String email, String SINNumber, String position) {
